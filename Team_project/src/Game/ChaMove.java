...
public class ChaMove extends PieceMove {      //CHA move(there is no restriction for range of move)
   int result, i, cnt, xx, yy;
   /*
    * 'result' is array coordinate .
    * 'i' is used in for loop.
    * 'cnt' is count variable and necessary for checking whether the piece jump over another piece
    * 'xx','yy' are later x,y
    */
   ...
   public boolean move(int[][] location, int x, int y, int currentx, int currenty, Color c, int turn) {
      ...
      if (c == Color.BLUE && turn == 0) {      //red piece moving, 'turn is 1' means red turn
